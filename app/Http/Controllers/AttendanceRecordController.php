...
class AttendanceRecordController extends Controller
{
    public function index(Request $request, $sessionId = null) {
        ...
        $records = AttendanceRecord::with(['student', 'markedBy'])->where('class_session_id', $session->id)->get();

        return response()->json(['session' => $session, 'attendance_records' => $records]);
    }
    ...
    public function store(Request $request) {
        ...
        $isIntegrityViolated = Carbon::parse($session->session_date)->isSameDay(now()) ? false : true;
        ...
        return response()->json(['message' => 'Attendance record created successfully.', 'record' => $record], 201);
    }
    ...
    public function update(Request $request, $id) {
        ...
        return response()->json(['message' => 'Attendance record updated successfully.', 'record' => $record]);
    }
